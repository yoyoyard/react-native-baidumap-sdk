...
var Component = /** @class */ (function (_super) {
    ...
    Component.prototype.call = function (command, params) {
        // @ts-ignore
        react_native_1.UIManager.dispatchViewManagerCommand(react_native_1.findNodeHandle(this), react_native_1.UIManager.getViewManagerConfig(this.nativeComponent).Commands[command], params);
    };
    /**
